...
<!-- 필요 작업
curl -X PUT "localhost:9200/air_quality" -H 'Content-Type: application/json' -d'
{
  "mappings": {
    "properties": {
      "@timestamp":      { "type": "date" },
      "Start_Date":      { "type": "date" },
      "Geo_Place_Name":  { "type": "keyword" },
...
curl -X POST "localhost:9200/air_quality/_doc" -H 'Content-Type: application/json' -d'
{
  "@timestamp": "2025-01-01T00:00:00Z",
  "Start_Date": "2025-01-01T00:00:00Z",
  "Geo_Place_Name": "Seoul",
  "Geo_Type_Name": "City",
  "Name": "PM10",
  "Data_Value": 42.3
}'
