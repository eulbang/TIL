...
# TODO: 샤드 상태 출력
print(es.cat.shards(index=index_name, format="text", v=True))
...
es.indices.put_settings(index=index_name, body={"index":{"routing.allocation.include._tier_preference":"data_warm"}})  
...
es.indices.put_settings(index=index_name, body={"index": {"routing.allocation.include._tier_preference": "data_cold"}})  
