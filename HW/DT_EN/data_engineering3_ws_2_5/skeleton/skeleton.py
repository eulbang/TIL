...
def create_index_with_replicas():
    ...
    es.indices.create(index=index_name, body={"settings":{"number_of_shards":2, "number_of_replicas":1}})  
    time.sleep(5)
...
def recover():
    ...
    es.cluster.put_settings(body={"persistent":{"cluster.routing.allocation.enable":"all"}})  
    time.sleep(5)
