...
작업 구성 예시:
- start (DAG 시작점)
- Task_A1, Task_B1, Task_C1 (병렬 실행 가능한 작업들)
- Task_A2, Task_B2, Task_C2 (상위 태스크 완료 후 실행되는 후속 작업들)
- end (모든 작업 완료 후 종료 처리)
...
```bash
suhyun@kjs:~/airflow/dags/scripts$ ls -al
total 12
drwxr-xr-x 2 suhyun suhyun 4096 Mar 28 19:45 .
drwxr-xr-x 4 suhyun suhyun 4096 Mar 28 18:15 ..
-rw-r--r-- 1 suhyun suhyun 639 Mar 28 19:45 spark_wordcount.py
```
